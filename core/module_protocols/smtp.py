...
class NettackSMTPLib:
    def smtp_brute_force(self, ports, usernames, passwords, timeout):
        smtp_connection = smtplib.SMTP(self, int(ports), timeout=int(timeout))
    ...
    def smtps_brute_force(self, ports, usernames, passwords, timeout):
        smtp_connection = smtplib.SMTP(self, int(ports), timeout=int(timeout))
